    ...
    <div class="row">
        <main class="px-4">
            ...
            <div class="page-header d-flex flex-column flex-md-row justify-content-between align-items-center">
                ...
                <a href="{{ route('leave.index') }}" class="btn-clean primary" style="border-radius: 50px;">
            ...
            <div class="form-container">
                <form action="{{ route('leave.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-actions" style="display: flex; justify-content: flex-end; gap: 1.25rem; padding-top: 1rem; margin-bottom: 1.5rem; border-top: 1px solid var(--border-light); flex-wrap: wrap;">
                        <a href="{{ route('leave.index') }}" class="btn-modern btn-secondary-modern shadow-sm" style="min-width: 140px; display: flex; align-items: center; justify-content: center; gap: 0.5rem; font-size: 1rem; font-weight: 600;">

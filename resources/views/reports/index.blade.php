            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card attendance h-100">
                    <div class="card-body text-center">
                        ...
                        <div class="stat-number">{{ $stats['attendance']['total'] }}</div>
                        <div class="stat-details">
                            <div class="d-flex justify-content-between">
                                <span><i class="fas fa-check-circle me-1"></i>Present: {{ $stats['attendance']['present'] }}</span>
                                <span><i class="fas fa-times-circle me-1"></i>Absent: {{ $stats['attendance']['absent'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card work-logs h-100">
                    <div class="card-body text-center">
                        ...
                        <div class="stat-number">{{ $stats['work_logs']['total'] }}</div>
                        <div class="stat-details">
                            <div class="d-flex justify-content-center">
                                <span><i class="fas fa-check-double me-1"></i>Completed: {{ $stats['work_logs']['completed'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card jobs h-100">
                    <div class="card-body text-center">
                        ...
                        <div class="stat-details">
                            <div class="d-flex justify-content-center">
                                <span><i class="fas fa-trophy me-1"></i>Completed: {{ $stats['jobs']['completed'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card leaves h-100">
                    <div class="card-body text-center">
                        ...
                        <div class="stat-number">{{ $stats['leaves']['total'] }}</div>
                        <div class="stat-details">
                            <div class="d-flex justify-content-between">
                                <span><i class="fas fa-thumbs-up me-1"></i>Approved: {{ $stats['leaves']['approved'] }}</span>
                                <span><i class="fas fa-clock me-1"></i>Pending: {{ $stats['leaves']['pending'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="comprehensiveReportModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('reports.comprehensive') }}" method="GET">
...
<div class="modal fade" id="workLogsReportModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('reports.work-logs') }}" method="GET">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
...
<div class="modal fade" id="leavesReportModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('reports.leaves') }}" method="GET">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">

        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('reports.leaves', array_merge(request()->all(), ['format' => 'pdf'])) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 mb-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="leave-type-badge">{{ ucfirst($type) }}</span>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="fw-bold">{{ $leave->employee->name }}</div>
                                ...
                                <td>
                                    <div>
                                        <small class="text-success">From: {{ $leave->start_date->format('M d, Y') }}</small><br>
                                        <small class="text-danger">To: {{ $leave->end_date->format('M d, Y') }}</small>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if($leave->approvedBy)
                                        <div>
                                            <small class="fw-bold">{{ $leave->approvedBy->username }}</small><br>
                                            @if($leave->approved_at)
                                                <small class="text-muted">{{ $leave->approved_at->format('M d, Y') }}</small>
                                            @endif
                                        </div>
                                    @else
                                        <span class="text-muted">-</span>
                                ...
                                <td>
                                    @if($leave->admin_notes)
                                        <div class="text-truncate" style="max-width: 150px;" title="{{ $leave->admin_notes }}">
                                            {{ Str::limit($leave->admin_notes, 30) }}
                                        </div>
                                    @else
                                        <span class="text-muted">-</span>
                                    @endif
    ...
    <div class="row mt-4 mb-4">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <div class="h5 text-success">
                            {{ $summary['total_leaves'] > 0 ? number_format(($summary['approved'] / $summary['total_leaves']) * 100, 1) : 0 }}%
                        </div>
                ...
                <div class="card-body">
                    <div class="text-center">
                        <div class="h5 text-info">
                            {{ $summary['approved'] > 0 ? number_format($summary['total_days'] / $summary['approved'], 1) : 0 }}
                        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <div class="h5 text-warning">{{ $leaves->groupBy('employee_id')->count() }}</div>

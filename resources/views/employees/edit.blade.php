...
<div class="container-fluid py-4" style="max-width: 100vw;">
    <!-- Page Header -->
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
                ...
                <a href="{{ route('employees.show', $employee->id) }}" class="btn-header">
                    <i class="fas fa-eye"></i> View Profile
                </a>
                <a href="{{ route('employees.index') }}" class="btn-header">
        ...
        <div class="form-card-body">
            <form method="POST" action="{{ route('employees.update', $employee) }}">
                ...
                <div class="form-actions" style="justify-content: flex-start;">
                    ...
                    <a href="{{ route('employees.index') }}" class="btn-modern btn-secondary-modern">
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <span class="status-badge status-info">{{ ucfirst($employee->user->role) }}</span>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Account Status</div>
                                        <div class="info-value">
                                            <span class="status-badge status-{{ $employee->user->is_active ? 'success' : 'danger' }}">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            {{ $employee->user->last_login ? $employee->user->last_login->format('M d, Y H:i') : 'Never logged in' }}
                                        </div>
                                    </div>
                                </div>

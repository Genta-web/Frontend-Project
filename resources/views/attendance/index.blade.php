                                            ...
                                            @if(Auth::user()->role === 'admin' || Auth::user()->role === 'hr' || Auth::user()->role === 'manager')
                                                <strong>
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       data-employee-name="{{ $attendance->employee->name ?? 'N/A' }}"
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger"
                                                onclick="confirmDelete('{{ $attendance->employee->name ?? 'Record' }} - {{ $attendance->date ? $attendance->date->format('d M Y') : 'N/A' }}', '{{ route('attendance.destroy', $attendance) }}')"
                                                title="Delete">
        ...
        window.addEventListener('load', function () {
            setTimeout(function() {
                if (typeof Swal === 'object' && typeof Swal.fire === 'function') {
                    ...
                    window.showAlert('Info', @json(session('status')), 'info');
                } else {

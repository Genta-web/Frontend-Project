            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end">
                    <div class="d-flex gap-2 justify-content-lg-end">
                        ...
                        <button type="button" class="btn btn-outline-light" onclick="clearReportsCache()" title="Clear Cache for Better Performance">
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100">
            <div class="card-header">
                <h6 class="report-title" style="color: #29b6f6;">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <button type="button" class="btn btn-success report-btn mt-auto" data-bs-toggle="modal"
                    ...
                    style="background: linear-gradient(135deg, #29b6f6 0%, #039be5 100%); border: none;">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100">
            <div class="card-header">
                <h6 class="report-title" style="color: #4fc3f7;">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <button type="button" class="btn btn-warning report-btn mt-auto" data-bs-toggle="modal"
                    ...
                    style="background: linear-gradient(135deg, #4fc3f7 0%, #0277bd 100%); border: none; color: #fff;">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100">
            <div class="card-header">
                <h6 class="report-title" style="color: #81d4fa;">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <button type="button" class="btn btn-info report-btn mt-auto" data-bs-toggle="modal"
                    ...
                    style="background: linear-gradient(135deg, #81d4fa 0%, #0288d1 100%); border: none; color: #fff;">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('reports.work-logs')); ?>" method="GET">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success btn-modal" style="background: linear-gradient(135deg, #29b6f6 0%, #039be5 100%); border: none;">
                        <i class="fas fa-chart-line me-1"></i>Generate Report
                    </button>
                </div>
            </form>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('reports.jobs')); ?>" method="GET">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-warning btn-modal" style="background: linear-gradient(135deg, #4fc3f7 0%, #0277bd 100%); border: none; color: #fff;">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('reports.leaves')); ?>" method="GET">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info btn-modal" style="background: linear-gradient(135deg, #81d4fa 0%, #0288d1 100%); border: none; color: #fff;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Gitlab\backoffice-fasya\resources\views/reports/index.blade.php ENDPATH**/ ?>
...
<div class="attendance-container">
    ...
    <div class="page-header">
        ...
        <div style="margin-top: 1.5rem; display: flex; gap: 1rem;">
            <a href="<?php echo e(route('attendance.edit', $attendance)); ?>" class="btn comprehensive-btn">
                <i class="fas fa-edit me-1"></i>
                Edit Record
            </a>
            <a href="<?php echo e(route('attendance.index')); ?>" class="btn comprehensive-btn">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\backoffice-fasya\resources\views/attendance/show.blade.php ENDPATH**/ ?>
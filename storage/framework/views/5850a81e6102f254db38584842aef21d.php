            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('dokumen.index')); ?>" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        ...
                        <a href="<?php echo e(route('dokumen.index')); ?>" class="btn btn-outline-info btn-reset-custom">
                            Reset
                        </a>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Integrasi KP\backoffice-fasya\resources\views/manajemen-dokumen/index.blade.php ENDPATH**/ ?>
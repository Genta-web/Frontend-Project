...
<div class="verify-account-container">
    <div class="verify-account-card">
        ...
        <h3 class="verify-account-title"><?php echo e(__('Account Verification')); ?></h3>
        ...
        <div class="account-info-card">
            ...
            <div class="account-detail">
                <span class="account-label"><?php echo e(__('Username:')); ?></span>
                <span class="account-value"><?php echo e($user->username); ?></span>
            </div>
            
            <div class="account-detail">
                <span class="account-label"><?php echo e(__('Full Name:')); ?></span>
                <span class="account-value"><?php echo e($user->employee->name ?? 'N/A'); ?></span>
            </div>
            
            <div class="account-detail">
                <span class="account-label"><?php echo e(__('Email:')); ?></span>
                <span class="account-value"><?php echo e($user->employee->email ?? 'N/A'); ?></span>
            </div>
            
            <div class="account-detail">
                <span class="account-label"><?php echo e(__('Department:')); ?></span>
                <span class="account-value"><?php echo e($user->employee->department ?? 'N/A'); ?></span>
            </div>
        </div>

        <p class="text-center mb-3" style="color: #666;">
            <?php echo e(__('Is this your account? If yes, you can proceed to reset your password.')); ?>
        ...
        <form method="POST" action="<?php echo e(route('password.reset-direct')); ?>" id="resetPasswordForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <a href="<?php echo e(route('password.request')); ?>" class="btn btn-secondary">
                    <i class="fas fa-arrow-left me-2"></i>
                    <?php echo e(__('Try Different Username')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Integrasi KP\backoffice-fasya\resources\views/auth/passwords/verify.blade.php ENDPATH**/ ?>
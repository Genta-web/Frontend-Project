                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="leave-row
                                ...
                                <?php endif; ?>
                            " data-status="<?php echo e($leave->status); ?>" data-leave-id="<?php echo e($leave->id); ?>">
                                <?php if(Auth::user()->hasRole(['admin', 'hr'])): ?>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="employee-details">
                                                ...
                                                <?php if($leave->employee->department): ?>
                                                    <br>
                                                    <small class="text-muted">
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        <?php elseif($leave->status === 'pending' && $leave->employee_id == Auth::user()->employee?->id): ?>
                                            ...
                                            <button type="button"
                                                    ...
                                                    onclick="showDeleteConfirmModal(<?php echo e($leave->id); ?>, '<?php echo e($leave->employee->name); ?>', '<?php echo e($leave->leave_type); ?>', '<?php echo e($leave->start_date); ?>', '<?php echo e($leave->end_date); ?>')">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Integrasi KP\backoffice-fasya\resources\views/leave/index.blade.php ENDPATH**/ ?>
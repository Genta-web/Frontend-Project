...
<div class="leave-detail-page py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb shadow-sm">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('leave.index')); ?>">Leave Management</a></li>
    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-lg-4">
            <div class="d-flex flex-wrap gap-2 justify-content-lg-end justify-content-start mt-3 mt-lg-0">
                <a href="<?php echo e(route('leave.index')); ?>" class="btn btn-light">
                    <i class="fas fa-arrow-left me-2"></i>Back to List
                </a>
                <?php if($leave->isPending() && Auth::user()->isEmployee() && $leave->employee_id == Auth::user()->employee?->id): ?>
                    <a href="<?php echo e(route('leave.edit', $leave)); ?>" class="btn btn-warning">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Integrasi KP\backoffice-fasya\resources\views/leave/show.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Employee Jobs Management'); ?>
...
<div class="jobs-page">
    ...
    <div class="card-clean">
        ...
        <div class="card-body-clean">
            <form method="GET" action="<?php echo e(route('job-batches.index')); ?>">
                <div class="row g-3">
                    <div class="col-md-3">
                        <label for="job_search" class="form-label">Search</label>
                        <input type="text" class="form-control" id="job_search" name="job_search"
                               value="<?php echo e(request('job_search')); ?>" placeholder="Search by job title or description...">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-control" id="job_status" name="job_status">
                            ...
                            <option value="pending" <?php echo e(request('job_status') == 'pending' ? 'selected' : ''); ?>>Pending</option>
                            <option value="in_progress" <?php echo e(request('job_status') == 'in_progress' ? 'selected' : ''); ?>>In Progress</option>
                            <option value="completed" <?php echo e(request('job_status') == 'completed' ? 'selected' : ''); ?>>Completed</option>
                            <option value="cancelled" <?php echo e(request('job_status') == 'cancelled' ? 'selected' : ''); ?>>Cancelled</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        ...
                        <select class="form-control" id="job_priority" name="job_priority">
                            ...
                            <option value="urgent" <?php echo e(request('job_priority') == 'urgent' ? 'selected' : ''); ?>>Urgent</option>
                            <option value="high" <?php echo e(request('job_priority') == 'high' ? 'selected' : ''); ?>>High</option>
                            <option value="medium" <?php echo e(request('job_priority') == 'medium' ? 'selected' : ''); ?>>Medium</option>
                            <option value="low" <?php echo e(request('job_priority') == 'low' ? 'selected' : ''); ?>>Low</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('job-batches.index')); ?>" class="btn btn-outline-secondary">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h6 class="m-0 font-weight-bold text-primary">
                        ...
                        <span class="badge bg-light text-dark ms-2"><?php echo e($employeeJobs->total()); ?></span>
                    </h6>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $employeeJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($job->isOverdue() ? 'table-danger' : ''); ?>" data-job-id="<?php echo e($job->id); ?>" data-status="<?php echo e($job->job_status); ?>">
                                    <?php if(Auth::user()->hasRole(['admin', 'hr'])): ?>
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input job-checkbox" type="checkbox" value="<?php echo e($job->id); ?>" id="job_<?php echo e($job->id); ?>" onchange="updateBulkActions()">
                                                <label class="form-check-label" for="job_<?php echo e($job->id); ?>"></label>
                                            </div>
                                        </td>
                                    <?php endif; ?>
                                    <td>
                                        <div>
                                            ...
                                            <?php if($job->isOverdue()): ?>
                                                <span class="badge bg-danger ms-1">OVERDUE</span>
                                            <?php endif; ?>
                                            <?php if($job->description): ?>
                                                <br><small class="text-muted"><?php echo e(Str::limit($job->description, 60)); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($job->employee): ?>
                                            <span class="badge bg-info"><?php echo e($job->employee->name); ?></span>
                                        <?php else: ?>
                                            <span class="text-muted">Unknown</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="badge <?php echo e($job->priority_badge_class); ?>">
                                            <?php echo e($job->priority_display); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge <?php echo e($job->job_status_badge_class); ?>">
                                            <?php echo e($job->job_status_display); ?>
                                    ...
                                    <td>
                                        <div class="progress" style="height: 20px;">
                                            <div class="progress-bar" role="progressbar"
                                                 ...
                                                 aria-valuenow="<?php echo e($job->progress_percentage); ?>"
                                                 aria-valuemin="0" aria-valuemax="100">
                                                <?php echo e($job->progress_percentage); ?>%
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($job->due_date): ?>
                                            <small><?php echo e($job->due_date->format('d M Y')); ?></small>
                                            <?php if($job->days_until_due < 0): ?>
                                                <br><small class="text-danger"><?php echo e(abs($job->days_until_due)); ?> days overdue</small>
                                            <?php elseif($job->days_until_due == 0): ?>
                                                <br><small class="text-warning">Due today</small>
                                            <?php elseif($job->days_until_due <= 3): ?>
                                                <br><small class="text-warning"><?php echo e($job->days_until_due); ?> days left</small>
                                            <?php else: ?>
                                                <br><small class="text-muted"><?php echo e($job->days_until_due); ?> days left</small>
                                            <?php endif; ?>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-sm btn-outline-info"
                                                    onclick="showJobDetails('<?php echo e($job->id); ?>', '<?php echo e(addslashes($job->name)); ?>', '<?php echo e(addslashes($job->description ?? '')); ?>', '<?php echo e($job->priority); ?>', '<?php echo e($job->job_status); ?>', <?php echo e($job->progress_percentage); ?>, '<?php echo e($job->due_date ? $job->due_date->format('d M Y') : ''); ?>', '<?php echo e($job->start_date ? $job->start_date->format('d M Y') : ''); ?>', '<?php echo e(addslashes($job->notes ?? '')); ?>')"
                                                    title="View Details">
                            ...
                            <div class="col-md-6">
                                <div class="pagination-info">
                                    <span class="text-muted">
                                        ...
                                        Showing <?php echo e($employeeJobs->firstItem()); ?> to <?php echo e($employeeJobs->lastItem()); ?> of <?php echo e($employeeJobs->total()); ?> results
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex justify-content-md-end justify-content-center mt-2 mt-md-0">
                                    <nav aria-label="Employee jobs pagination">
                                        <div class="pagination-wrapper">
                                            <?php echo e($employeeJobs->appends(request()->query())->links('custom.pagination')); ?>
...
document.getElementById('confirmBulkDelete').addEventListener('click', function() {
    ...
    // Send delete request
    fetch('<?php echo e(route("job-batches.bulk-delete")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Integrasi KP\backoffice-fasya\resources\views/job-batches/index.blade.php ENDPATH**/ ?>
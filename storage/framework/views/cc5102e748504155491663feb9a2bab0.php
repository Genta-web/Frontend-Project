            ...
            <div class="form-container">
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                                ...
                                <div style="word-wrap: break-word; word-break: break-word; white-space: normal; max-width: 100%;">
                                    ...
                                    <?php if($document->uploader): ?>
                                        <small class="text-muted" style="word-wrap: break-word; word-break: break-all; white-space: normal; display: block; margin-top: 4px;">
                                            <i class="fas fa-envelope me-1"></i><?php echo e($document->uploader->email ?? ''); ?>

                                        </small>
                                        <small class="text-muted" style="display: block; margin-top: 2px;">
                                            <i class="fas fa-calendar me-1"></i>Uploaded on <?php echo e($document->created_at->format('d M Y, H:i')); ?>
                        ...
                        <form action="<?php echo e(route('dokumen.update', $document->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                    ...
                                    <div class="current-file-info">
                                        <div class="d-flex align-items-start justify-content-between">
                                            <div style="word-wrap: break-word; word-break: break-word; white-space: normal; max-width: 70%;">
                                                ...
                                                <?php if($document->original_name && $document->file_size): ?>
                                                    <small class="text-muted" style="word-wrap: break-word; white-space: normal; display: block; margin-top: 4px;">
                                                        <i class="fas fa-weight me-1"></i><?php echo e($document->formatted_file_size); ?>

                                                        <?php if($document->mime_type): ?>
                                                            <span class="ms-2">
                                                                <i class="fas fa-info-circle me-1"></i><?php echo e($document->mime_type); ?>
                                ...
                                <input type="file"
                                       class="form-control <?php $__errorArgs = ['path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          name="description"
                                          rows="4"
                                          placeholder="Enter document description (optional)"><?php echo e(old('description', $document->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-actions">
                                <a href="<?php echo e(route('dokumen.index')); ?>" class="btn-modern btn-secondary-modern" style="color: #ff8080;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dimas\Desktop\Integrasi KP\backoffice-fasya\resources\views/manajemen-dokumen/edit.blade.php ENDPATH**/ ?>